"""migrate table models to new database

Revision ID: fc244b31410f
Revises: ef432ff369a0
Create Date: 2024-06-17 17:00:23.283785
...
revision = 'fc244b31410f'
down_revision = 'ef432ff369a0'
branch_labels = None
depends_on = None
